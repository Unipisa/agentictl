...
- Install shared runtime libraries under `/opt/agentictl/lib/agentictl`.
- Install built-in modules under `/opt/agentictl/modules`.
...
- Remove built-in module directories and shared runtime libraries during uninstall while preserving unrelated custom modules unless `--remove-base-dir` is supplied.
...
The tarball must include source scripts, docs, requirements, tests, installer, shared runtime libraries, modules, and skill files.
